  ...
  return (
    <MountContext.Provider value={{ mount }}>
      <i
        ...
        className="pointer-events-none fixed bottom-0 left-0 right-0 top-0 z-130 block h-full w-full select-none bg-white transition-opacity delay-1000 duration-1000 dark:bg-black"
      />
      {children}
