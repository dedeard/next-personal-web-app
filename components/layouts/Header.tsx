...
const Header = forwardRef((_, ref: React.ForwardedRef<HTMLDivElement>) => {
  ...
  return (
    <>
      ...
      <header
        ref={ref}
        className="fixed top-0 left-0 right-0 z-[100] flex h-16 w-full flex-row overflow-hidden bg-white/90 dark:bg-black/90 md:top-0 md:right-auto md:h-full md:w-16 md:flex-col"
      >
